...
def _figures(cfg: Config, root: Path, events: pd.DataFrame, episodes: pd.DataFrame) -> list[str]:
    ...
    colors = {"A+": "#1b9e77", "A": "#377eb8", "B": "#999999", "proxy": "#e66101", "unrated": "#bdbdbd"}
...
def run(cfg: Config) -> dict:
    ...
    sources = [cfg.config_path, cfg.resource_path("calibration_workbook"), cfg.resource_path("calibration_event_registry")]
